          ...
          {!!data &&
            data.map((item, index) => (
              <div key={item.id} className="grid-item">
                ...
                <div className={!item.completed ? "differ" : "differs"}>
                  <div
                    className="info"
...
//         <form id="to-do-form">
//           <label>
//             <input type="text" name="name" className="text1" placeholder="Enter the task here" />
//           </label>
//           <input type="submit" value="Submit" id="text2" />
//         </form>
//         <br></br>
...
//               <div className="differ"><div className="info">
//                 {/* User_Id: { item.userId},
//                     id: { item.id },  */}
